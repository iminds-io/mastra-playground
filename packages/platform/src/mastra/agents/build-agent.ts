// ABOUTME: Single factory for workspace-aware Mastra agents in this platform.
...
const WORKSPACE_AGENT_MEMORY_OPTIONS = { observationalMemory: false } as const;

export function buildWorkspaceAgent<TId extends string, TToolkit extends Toolkit>({
  id,
  name,
  description,
  instructions,
  ...
  workflows,
  defaultOptions,
}: WorkspaceAgentInput<TId, TToolkit>): Agent<TId, TToolkit, undefined, ProjectAgentRequestContext> {
